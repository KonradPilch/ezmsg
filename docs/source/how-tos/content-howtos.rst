...
.. AxisArray Message Format
.. ************************

.. ``ezmsg`` provides a specialized message format for handling multidimensional data arrays, known as AxisArray. This section covers how to work with AxisArray messages.
